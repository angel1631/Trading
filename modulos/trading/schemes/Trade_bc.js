...
export default {
    ...
    fields: [
        ...
        {id: 'cantidad_recibe', typeDB: 'decimal(65,16)', type: 'decimal', description: 'Cantidad de divisa que recibe', def:'0', disabled: true},
        {id: 'fecha', type:'date', description: 'Fecha del trade', def: ()=>{let now = new Date(); now = getDateShort(now); return now}},
        {id: 'valor', type:'decimal(65,16)', type: 'moneda', description: 'Valor del almacen', def:'0'},
        {id: 'margen', type:'decimal(65,16)', type: 'moneda', description: 'Margen del almacen', def:'0'}
    ],
}